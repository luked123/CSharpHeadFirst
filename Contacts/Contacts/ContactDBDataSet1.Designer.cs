    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[People] WHERE (([ContactID] = @Original_ContactID) AND ((@IsNu" +
                ...
                "ull_Last_Call = 1 AND [Last Call] IS NULL) OR ([Last Call] = @Original_Last_Call" +
                ")))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[People] ([Name], [Company], [Telephone], [Email], [Client], [Last Call]) VALUES (@Name, @Company, @Telephone, @Email, @Client, @Last_Call);
SELECT ContactID, Name, Company, Telephone, Email, Client, [Last Call] FROM People WHERE (ContactID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [Name] = @Name, [Company] = @Company, [Telephone] = @Telephone, [Email] = @Email, [Client] = @Client, [Last Call] = @Last_Call WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_Last_Call = 1 AND [Last Call] IS NULL) OR ([Last Call] = @Original_Last_Call)));
SELECT ContactID, Name, Company, Telephone, Email, Client, [Last Call] FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, Name, Company, Telephone, Email, Client, [Last Call] FROM dbo.P" +
                "eople";
        ...
        public virtual int Delete(int Original_ContactID, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_Last_Call) {
        ...
        public virtual int Update(string Name, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> Last_Call, int Original_ContactID, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_Last_Call, int ContactID) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> Last_Call, int Original_ContactID, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_Last_Call) {
            return this.Update(Name, Company, Telephone, Email, Client, Last_Call, Original_ContactID, Original_Client, Original_Last_Call, Original_ContactID);
        }
    }
